...
if [ "$user" == "root" ]; then
	...
	sudo pacman -S --needed --noconfirm meson libxext libxcb xcb-util-renderutil xcb-util-image pixman dbus libconfig-dev mesa pcre2 pcre libevdev uthash libev libx11 
	exit_code=$?
