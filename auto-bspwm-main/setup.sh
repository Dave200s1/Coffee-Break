...
if [ "$user" == "root" ]; then
	...
	sudo pacman -S --noconfirm alacritty rofi feh xclip ranger scrot wmname imagemagick cmatrix htop screenfetch python-pip procps-ng fzf lsd bat pamixer flameshot clang curl ttf-font-awesome ninja
	official_exit=$?
